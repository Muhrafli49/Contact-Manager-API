...
import { createTestAddress, createTestUser, removeAllTestContacts, removeTestUser, createTestContact, getTestContact, removeAllTestAddresses, getTestAddress } from "./test-util";
...
describe('DELETE /api/contacts/:contatsId/addresses/:addressId', () => {
    beforeEach(async () => {
        await createTestUser();
        await createTestContact();
        await createTestAddress();
...
describe('GET /api/contacts/:contatsId/addresses', () => {
    beforeEach(async () => {
        await createTestUser();
        await createTestContact();
        await createTestAddress();
